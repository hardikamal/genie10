package com.supergenieapp.android.CustomViews.ProgressBar;
...
public class SplashScreenProgressCircle extends View {
    ...
    public SplashScreenProgressCircle(Context context) {
        super(context);
        init(null, 0);
    }

    public SplashScreenProgressCircle(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public SplashScreenProgressCircle(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        int color = a.getColor(R.styleable.CircleProgress_bubbleColor, BLUE);
        a.recycle();
    ...
    private void calPoints(float factor) {
        ...
        for (int i = 0; i < POINT_NUM; ++i) {
            ...
            ArcPoint point = new ArcPoint(x, y, COLORS[0]);
            mArcPoint[i] = point;
        }
    }
